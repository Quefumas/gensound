...
from gensound.signals import Sine, Triangle
from gensound.filters import MovingAverage, Downsample
from gensound.curve import CompoundCurve, Curve, Constant, Line, Logistic, SineCurve
from gensound.playback import play_WAV, play_Audio, export_test
...
def test_glis():
    ...
    s = Triangle(frequency=c5, duration=12e3) * Downsample(factor=10) * MovingAverage(7)
